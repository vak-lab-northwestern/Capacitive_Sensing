...
df_cap = df_cap[df_cap['Timestamp'] > '2025-07-23 16:30:00']  # Ensure only relevant columns
...
fig = make_subplots(
    ...
    subplot_titles=('CH0 pF', 'CH1 pF'), row_heights=[0.5, 0.5]
)
...
fig.update_layout(
    ...
    title_text='Capacitive Sensor Data (Pothos and Lily)',
    showlegend=True
)
